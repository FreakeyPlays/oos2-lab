...
/**
 * A utility class with static method to perform usefull calculations with
...
public class CoordinatesCalculations {
	...
	/**
	 * Calculates if target is inside a square area where center is the center of
	 * the square and radius is half the side of the square.
	 * 
	...
	/**
	 * Calculates if target is inside a circle area where center is the center of
	 * the circle
	 * 
	 * @param coordinate Target coordinate
	 * @param center     Center coordinate
	...
	/**
	 * Calculates the end-point from a given source at a given range (meters) and
	 * bearing (degrees). This methods uses simple geometry equations to calculate
	 * the end-point.
	 * 
	 * @see <a href=
	 *      "stackoverflow.com">http://stackoverflow.com/questions/3695224/sqlite-getting-nearest-locations-with-latitude-and-longitude</a>
	 ...
	 * 
	 * @see <a href=
	 *      "gis.stackexchange.com">http://gis.stackexchange.com/questions/25877/how-to-generate-random-locations-nearby-my-location</a>
