...
public class PlaneDataServer implements Runnable {
	...
	/**
	 * Constructor der Klasse PlaneDataServer Ruft Streaming Webclient auf und
	 * empfaengt Daten von der OpenSky API
	 *
	...
	/**
	 * Methode zur Ermittlung des Arrays der Flugzeuge Auch werden die Flugzeuge aus
	 * dem Array gefiltert, welche ausserhalb der maximalen Distanz liegen Verwendet
	 * die Klassen Coordinates und CoordinatesCalculations siehe
	 * https://github.com/dvdme/GeoCoordinatesLib.git
	 *
	...
	public JSONArray getPlaneArray() {
		...
		if (debug)
			System.out.println("planeArray " + planeArray.length() + "  " + planeArray);
		return returnArray;
	}
	...
	/**
	 * Methode zur Rueckgabe von Dummydaten Wird verwendet, wenn das planeArray
	 * nicht gefuellt ist
	 *
	 * @return returnArray Array mit den gefilterten Flugzeugen
	 */
	...
	public void run() {
		while (!exit) {
			...
			if (debug)
				System.out.println("Sentence " + json + "\n\n\n");
